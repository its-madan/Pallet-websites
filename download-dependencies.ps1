...
"@
        ...
        Write-Host "SUCCESS: Created $pomFile"
...
$dependencies = @(
    ...
    @{
        ...
        ArtifactId = "spring-data-commons"
        Version = "3.2.0"
        DownloadUrl = "https://repo1.maven.org/maven2/org/springframework/data/spring-data-commons/3.2.0/spring-data-commons-3.2.0.pom"
    },
    @{
    ...
    @{
        GroupId = "org.springframework.data"
        ArtifactId = "spring-data-repository"
        Version = "3.2.0"
        DownloadUrl = "https://repo1.maven.org/maven2/org/springframework/data/spring-data-repository/3.2.0/spring-data-repository-3.2.0.jar"
    },
    @{
        GroupId = "org.springframework"
